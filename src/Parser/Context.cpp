...
//
//-----------------------------------------------------------------------------
ResultState Context::LookupPreprocessedIncludeFile(CompileUnitFile* rootCompileUnitFile, const TokenPathName& basePath, const TokenPathName& filePath, const Array<TokenPathName>* additionalIncludePaths, const MacroMapContainer& parentMacroMap, DiagnosticsItemSet* parentDiag, IncludeFile** outFile)
{
	...
	else
	{
		...
		LN_RESULT_CALL(preprocessor.BuildPreprocessedTokenList(this, rootCompileUnitFile, tokens, codeFile, additionalIncludePaths, parentMacroMap, parentDiag));
